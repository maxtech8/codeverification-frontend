...
const SideTab = () => (
  <FadeInWhenVisible className="grid grid-cols-3">
    ...
    transition duration-[300ms] hover:scale-[1.1]"
    >
      <p className="px-[10px]">FOR DEVELPOPERS</p>
    ...
    transition duration-[300ms] hover:scale-[1.1]"
    >
      <p className="px-[10px]">TRAFFIC GENERATOR</p>
      <span className="w-full h-[3px] flex items-center mt-[5px]">
        <span className="bg-[#39393d] w-full h-[1px]" />
      </span>
    </button>
